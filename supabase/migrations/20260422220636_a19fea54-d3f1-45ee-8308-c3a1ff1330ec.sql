...
BEGIN
  ...
  ELSIF p_action = 'deliver_customer' THEN
    -- SURGICAL FIX: fulfillment_status no tiene 'delivered_to_third_party'.
    -- Se usa 'delivered' (valor válido del enum) en fulfillment_orders.
    -- branch_requests SÍ tiene 'delivered_to_third_party' en su enum y se mantiene.
    v_new_status := 'delivered';
